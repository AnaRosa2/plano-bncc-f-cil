...
// Disciplinas iniciais (vazio para começar)
export const disciplinasIniciais: Disciplina[] = [];

// Unidades iniciais (vazio para começar)
export const unidadesIniciais: Unidade[] = [];

// Planos de aula iniciais (vazio para começar)
export const planosAulaIniciais: PlanoAula[] = [];

// Atividades avaliativas iniciais (vazio para começar)
